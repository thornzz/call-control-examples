...
const ce = "drop", se = "answer", ae = "divert", $ = "transferto", U = "Connected", oe = "Dialing", Z = "Ringing", de = ({ ref: t, handler: i }) => {
  ...
  const [p, x] = m(!1), v = R(null);
  de({
    ref: v,
    handler: () => x(!1)
  });
  const [l, L] = m(
    s ? i.find((a) => a.device_id === s) : void 0
  ), T = (a) => {
    L(a), f && f(a.device_id), x(!1);
  };
  return k(() => {
    if (s && i) {
      const a = i.find((C) => C.device_id === s);
      a && L(a);
    } else
      L(void 0);
  }, [s, i]), /* @__PURE__ */ e(
      ...
      children: /* @__PURE__ */ h("div", { className: "group", children: [
        /* @__PURE__ */ h(
          "button",
          {
            ...
            onClick: () => x(!p),
            children: [
              /* @__PURE__ */ e("span", { children: (l == null ? void 0 : l.user_agent) || t }),
              /* @__PURE__ */ e(
                "svg",
                {
        ...
        p && /* @__PURE__ */ e("ul", { className: "absolute w-full left-0 origin-top-left bg-darklight text-white divide-y divide-gray-100 shadow-lg", children: i == null ? void 0 : i.map((a) => /* @__PURE__ */ e(
          "li",
          {
            onClick: () => T(a),
            className: "block px-4 py-2 text-sm text-white-600 cursor-pointer border-none hover:bg-bghover",
            children: a.user_agent
          },
          a.device_id
        )) })
      ] })
  ...
  /* @__PURE__ */ e(
    "button",
    {
      disabled: f.length < 1 || t,
      className: "bg-green-500 p-2 rounded-md disabled:bg-gray-400",
      onClick: () => i(),
      children: t ? /* @__PURE__ */ e(S, {}) : "Proceed"
    }
  )
] });
var P = /* @__PURE__ */ ((t) => (t[t.Idle = 0] = "Idle", t[t.Dialing = 1] = "Dialing", t[t.Ringing = 2] = "Ringing", t[t.Connected = 3] = "Connected", t))(P || {});
function ge(t, i) {
  switch (i.type) {
    case "full_update":
      return i.newState !== void 0 ? {
        ...i.newState,
        attachedData: {
          ...i.newState.attachedData,
          ...(t == null ? void 0 : t.attachedData) || []
          // we keep old attached data because it can contain hubspot data
        }
      } : void 0;
    case "attach_data":
      return i.attachedData !== void 0 && t !== void 0 ? {
        ...t,
        attachedData: i.attachedData
      } : t;
  }
}
const xe = ({
  ...
  const [a, C] = m(v ?? ""), [c, q] = m(
    ...
    ge,
    void 0
  ), [b, N] = m(void 0), [D, I] = m(""), [M, O] = m(!1), [K, z] = m(!1), [W, F] = m(!1), [Q, V] = m(!1), E = R(null), A = R(null), _ = R(null);
  k(() => {
    const r = new EventSource(t);
    return r.onopen = () => {
      console.log("EventSource Connected"), l == null || l.initialized({
        isLoggedIn: !0,
        sizeInfo: { width: 400, height: 600 },
        engagementId: T
      });
    }, r.onerror = console.error, r.onmessage = function(d) {
      try {
    ...
    c === 0 && v && v.length > 0 && G(v);
  }, [v]), k(() => {
    y({
      type: "attach_data",
      attachedData: { engagementId: T }
    });
  }, [T]), k(() => {
    const r = g == null ? void 0 : g.find(
      (o) => o.status === U
    ), d = g == null ? void 0 : g.find(
      (o) => o.status === Z
    ), u = g == null ? void 0 : g.find(
      (o) => o.status === oe
    );
    if (r && c !== 3 && (c === 1 && (l == null || l.callAnswered()), w(
      3
      /* Connected */
    ), y({ type: "full_update", newState: r })), u && !n && (y({ type: "full_update", newState: u }), c !== 1 && w(
      1
      /* Dialing */
    ), l == null || l.outgoingCall({
      ...
      2
      /* Ringing */
    ), y({ type: "full_update", newState: d })), g.find((o) => {
      if (o.callid && o.legid && (n != null && n.callid) && n.legid)
        return (o == null ? void 0 : o.callid) + (o == null ? void 0 : o.legid) === n.callid + n.legid;
    }) === void 0 && n !== void 0 && c !== 0) {
      const o = n.status === U ? "COMPLETED" : "CANCELED";
      l == null || l.callEnded({
        callEndStatus: o
      }), l == null || l.callCompleted({
        engagementId: n.attachedData.engagementId,
  ...
  const X = () => {
    ...
    for (let d = 1; d <= 12; d++) {
      let u = "";
      d < 10 ? u = d : d === 10 ? u = "*" : d === 11 ? u = 0 : d === 12 && (u = "#"), r.push(
        /* @__PURE__ */ e(
          "button",
          {
            onClick: () => C((H) => H + u),
    ...
    if ((n == null ? void 0 : n.status) === Z && n.directControll) {
      z(!0);
      try {
        await p(
          se,
    ...
    } else if (r != null && r.length || a.length)
      try {
        await f(r || a), C(""), c !== 1 && (w(
          1
          /* Dialing */
        ), _.current = setTimeout(() => {
          V(!0), g.length === 0 && (A.current = setTimeout(() => {
            g.length === 0 && w(
              0
              /* Idle */
            );
        ...
        w(
          0
          /* Idle */
        ), _.current && clearTimeout(_.current), A.current && clearTimeout(A.current);
      }
  };
  function w(r) {
    q(r), A.current && clearTimeout(A.current), _.current && clearTimeout(_.current);
  }
  return /* @__PURE__ */ h("div", { className: "w-[400px] h-[600px] bg-darkBg flex flex-col", children: [
      ...
      "div",
      {
        ...
        children: [
            ...
            switch (c) {
              ...
              case 2:
                return /* @__PURE__ */ h("div", { className: "flex flex-col items-center justify-end", children: [
                  /* @__PURE__ */ e("span", { children: n != null && n.party ? /* @__PURE__ */ h("div", { className: "flex flex-col gap-2", children: [
                    /* @__PURE__ */ e("span", { className: "text-center", children: n.party }),
                    /* @__PURE__ */ h(
                      "span",
                      {
                  ...
                  (n == null ? void 0 : n.name) && /* @__PURE__ */ e("span", { children: n.name })
                ] });
            }
          })(),
          c === 0 && /* @__PURE__ */ e("div", { className: "flex justify-end items-center", children: /* @__PURE__ */ e(
            J,
            {
              onClickBS: () => C(a.substring(0, a.length - 1))
            }
          ) }),
          c !== 0 && b !== void 0 && /* @__PURE__ */ e(
            fe,
            {
              inputRef: E,
              onOperation: ee,
              onPerformingOperation: M,
              destinationNumber: D,
              setDestinationNumber: I,
              label: b === $ ? "Transfer to:" : "Divert to:"
            }
          )
        ]
      }
    ),
    c === 0 ? /* @__PURE__ */ e("div", { className: "h-3/5 border-t-2 border-b-2 border-darklight grid grid-cols-3 text-white text-center font-bold text-lg", children: X() }) : /* @__PURE__ */ e(
      he,
      {
        onCallAction: Y,
        state: c,
    ...
    /* @__PURE__ */ h("div", { className: "h-1/6 flex flex-row", children: [
      (c === 0 || c === 2) && /* @__PURE__ */ e("div", { className: "flex justify-center items-center w-full", children: /* @__PURE__ */ e(
        ...
        {
          type: "button",
          disabled: W || K || (n !== void 0 ? n.directControll !== !0 : !1),
          onClick: () => G(),
  ...
  "button",
  {
    ...
    children: f ? /* @__PURE__ */ e(S, {}) : s
  }
), be = ({ message: t }) => /* @__PURE__ */ h("div", { className: "bg-red-200 px-6 py-4 my-4 rounded-md flex items-center mx-auto max-w-lg", children: [
  /* @__PURE__ */ e("svg", { viewBox: "0 0 24 24", className: "text-red-600 w-8 h-8 mr-3", children: /* @__PURE__ */ e(
    "path",
    {
      fill: "currentColor",
